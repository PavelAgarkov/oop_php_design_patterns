...
Для запуска демонстрации конкретного шаблона нужно раскомментировать подключение соответвующего файла demontration.php из директории шаблона в файле src/index.php.
